...
«losresiduo» terms{
resto basura desecho suciedad inutilidad sobra
ciclo reciclaje recurso limpieza
}terms
...
«yconsabore» terms{
lengua boca paladar gusto
amargura dulzura acidez
}terms
...
«quizaempie» terms{
comienzo inicio
base pierna soporte tierra suelo camino
}terms

«oporlaespa» terms{
columna base soporte tierra suelo superficie pared cuerpo
}terms

«oportusman» terms{
extremidad miembro brazo dedo cuerpo
}terms
